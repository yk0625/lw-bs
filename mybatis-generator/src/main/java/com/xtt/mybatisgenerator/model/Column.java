...
import com.xtt.mybatisgenerator.utils.DatabaseDataTypesUtils;
import com.xtt.mybatisgenerator.utils.StringHelper;
...
public class Column
{
     ...
     * @param sqlRemark
     */
    public Column(Table table, int sqlType, String sqlTypeName, String sqlName, int size, int decimalDigits, boolean isPk, boolean isFk, boolean isNullable, boolean isIndexed, boolean isUnique, String defaultValue, String sqlRemark)
    {
        _table = table;
        _sqlType = sqlType;
        _sqlName = sqlName;
