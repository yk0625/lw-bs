...
import com.xtt.mybatisgenerator.model.Column;
import com.xtt.mybatisgenerator.model.Table;
import com.xtt.mybatisgenerator.utils.PropertiesProvider;
...
public class DbModelHelper
{
    ...
    private List getTableColumns(Table table, List primaryKeys, List indices, Map uniqueIndices, Map uniqueColumns) throws SQLException
    {
        ...
        while (columnRs.next()) {
            ...
            Column column = new Column(table, sqlType, sqlTypeName, columnName, size, decimalDigits, isPk, ifFk, isNullable, isIndexed, isUnique, columnDefaultValue, columnRemark);
            columns.add(column);
        }
        columnRs.close();
        return columns;
